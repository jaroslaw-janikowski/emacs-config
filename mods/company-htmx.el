...
(defvar attr-completions
  '(
	...
	#("hx-disable-elt" 0 1 (:annotation "Attr" :help ""))
	#("hx-disinherit" 0 1 (:annotation "Attr" :help ""))
	#("hx-ext" 0 1 (:annotation "Attr" :help ""))
	#("hx-encoding" 0 1 (:annotation "Attr" :help ""))
	#("hx-get" 0 1 (:annotation "Attr" :help ""))
	#("hx-header" 0 1 (:annotation "Attr" :help ""))
	#("hx-history" 0 1 (:annotation "Attr" :help ""))
	#("hx-history-elt" 0 1 (:annotation "Attr" :help ""))
	...
	#("hx-prompt" 0 1 (:annotation "Attr" :help ""))
	#("hx-replace-url" 0 1 (:annotation "Attr" :help ""))
	#("hx-request" 0 1 (:annotation "Attr" :help ""))
	...
	#("hx-on" 0 1 (:annotation "Attr" :help ""))
	...
	#("hx-vals" 0 1 (:annotation "Attr" :help ""))
	#("hx-validate" 0 1 (:annotation "Attr" :help ""))
	))
